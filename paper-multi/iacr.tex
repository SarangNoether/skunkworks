...
A later advancement to the RingCT protocol used Pedersen commitments to amounts associated with transaction outputs and extended a ring signature construction by Liu \text{et al.} to support parallel signatures in a matrix arrangement \cite{ringct,liu}.
...
Figures \ref{fig:sigma} and \ref{fig:sigma2} describes the prover and verifier interaction.
