...
class TestValidSignatures(unittest.TestCase):
    ...
    def test_n_2_l_0_mixed(self):
        p = random_scalar()
        P = [G*p,random_point()]
        t = [TYPE_LEGACY,TYPE_NEW]
        z = random_scalar()
        C = [G*z,random_point()]
        M = 'Test message'
    ...
    def test_n_2_l_0_mixed_2(self):
        p = random_scalar()
        P = [G*p,random_point()]
        t = [TYPE_NEW,TYPE_LEGACY]
        z = random_scalar()
        C = [G*z,random_point()]
        M = 'Test message'
...
class TestBadPoints(unittest.TestCase):
    def test_n_1_bad_P_legacy(self):
        p = random_scalar()
        P = [random_point()]
        t = [TYPE_LEGACY]
        z = random_scalar()
        ...
        sig = sign(M,p,P,t,z,C,index=0)
        with self.assertRaises(ArithmeticError):
            verify(M,P,t,C,sig)

    def test_n_1_bad_P_new(self):
        p = random_scalar()
        P = [random_point()]
        t = [TYPE_NEW]
        z = random_scalar()
    ...
    def test_n_1_bad_C_legacy(self):
        p = random_scalar()
        P = [G*p]
        t = [TYPE_LEGACY]
        z = random_scalar()
    ...
    def test_n_2_index_swap_1(self):
        ...
        sig = sign(M,p,P,t,z,C,index=1)
        with self.assertRaises(ArithmeticError):
            verify(M,P,t,C,sig)

class TestTransaction(unittest.TestCase):
    # Type full: 1 in, 2 out
    def test_full_1_2_legacy(self):
        n = 3 # ring size
    ...
    def test_simple_1_2_legacy(self):
        n = 3 # ring size
        l = 1 # secret ring index
