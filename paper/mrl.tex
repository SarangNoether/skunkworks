...
\authors{Brandon Goodell\footnote{\texttt{surae.noether@protonmail.com}} and Sarang Noether\footnote{\texttt{sarang.noether@protonmail.com}} and Arthur Blue\footnote{\texttt{randomrun@protonmail.com}}}
\affiliations{Monero Research Lab, independent researcher}
\date{\today}
...
\item $\texttt{M}$ sends to $\texttt{A}$ the signature $\left(\sigma, \mathfrak{T}_{i(\ell)}\right)$ where the signature $\sigma = (c_1, s_1, \ldots, s_n, \left\{\mathfrak{D}_j\right\}_j)$.
\end{enumerate}
